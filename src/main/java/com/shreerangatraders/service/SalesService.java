...
public class SalesService {
    ...
    public Sales createSale(Sales sale) {
        ...
        if (sale.getPaymentType() == Sales.PaymentType.CREDIT) {
            updateCustomerBalance(sale.getCustomerName(), sale.getAmount(), "Sale #" + saved.getId());
        }
    ...
    public Sales updateSale(Long id, Sales sale) {
        ...
        if (difference.compareTo(BigDecimal.ZERO) != 0) {
            updateCustomerBalance(sale.getCustomerName(), difference, "Sale #" + id + " updated");
        }
    ...
    public void deleteSale(Long id) {
        ...
        if (sale.getPaymentType() == Sales.PaymentType.CREDIT) {
            updateCustomerBalance(sale.getCustomerName(), sale.getAmount().negate(), "Sale #" + id + " deleted");
        }
    }
